export default {
    ...
    watchedTraffic: {
      title: 'Watched user traffic',
      hint: 'Records prompts and upstream responses for listed users only. No content moderation, no external API. Turning it off is a fast path. Observation-pool isolation is unchanged.',
      switchLabel: 'Recording',
      on: 'Recording',
      off: 'Off',
      userIds: 'User IDs',
      userIdsHint: 'Comma-separated. New keys for the same user stay in scope. If they complain about latency, flip this off first.',
      userIdsPlaceholder: 'e.g. 295',
      ...
      enabled: 'Traffic recording is on',
      disabled: 'Traffic recording is off; requests take the fast path',
      saved: 'Saved',
      loadFailed: 'Failed to load watched traffic config',
      saveFailed: 'Failed to save watched traffic config',
      logsFailed: 'Failed to load watched traffic logs',
    },
