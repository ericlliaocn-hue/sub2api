...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeHuifu:     {"merchantprivatekey": {}, "huifupublickey": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeHuifu:     {"sysid": {}, "huifuid": {}, "productid": {}, "projectid": {}, "merchantprivatekey": {}, "huifupublickey": {}, "apibase": {}, "notifyurl": {}, "returnurl": {}},
}
