      ...
      <table class="w-full text-left text-sm">
        <thead class="border-b border-gray-200 dark:border-dark-700">
          <tr class="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400">
            ...
            <th class="py-2 pr-3">{{ t('channelStatus.detailColumns.availability1d') }}</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-2 pr-3 text-gray-700 dark:text-gray-300">{{ formatPercent(m.availability_1d) }}</td>
