<template>
  ...
  <AppLayout v-if="isEmbedded">
    <ModelPlazaContent class="font-pixel" :response="data" :loading="loading" :error="loadFailed" embedded />
  </AppLayout>

  <!-- 独立形态:自带导航条(logo/站名 + 登录/回后台) -->
  <div v-else class="font-pixel min-h-screen bg-gray-50 dark:bg-dark-950">
    <PlazaNavBar />
