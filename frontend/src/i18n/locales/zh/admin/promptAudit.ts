export default {
  promptAudit: {
    ...
    metrics: { total: '总计', allowed: '放行', flagged: '标记', blocked: '阻止', busy: '繁忙', unavailable: '不可用', timeouts: '超时', failovers: '故障切换' },
    pool: {
    ...
    saveBar: { enabled: '启用提示词审计', blocking: '同步阻止', blockingLatestTurnOnly: '同步仅审最新客户端回合（完整上下文后台复核）', storePass: '保存安全事件', dirty: '有未保存的更改', synced: '配置已同步' },
    blockingConfirm: {
      title: '开启同步阻止？',
