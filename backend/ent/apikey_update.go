...
func (_u *APIKeyUpdate) SetSubPoolID(v int64) *APIKeyUpdate {
	_u.mutation.SetSubPoolID(v)
	return _u
}

// SetNillableSubPoolID sets the "sub_pool_id" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableSubPoolID(v *int64) *APIKeyUpdate {
	if v != nil {
		_u.SetSubPoolID(*v)
	}
	return _u
...
func (_u *APIKeyUpdate) ClearSubPoolID() *APIKeyUpdate {
	_u.mutation.ClearSubPoolID()
	return _u
}
...
func (_u *APIKeyUpdate) SetSubPool(v *SubPool) *APIKeyUpdate {
...
func (_u *APIKeyUpdate) ClearSubPool() *APIKeyUpdate {
...
// SetSubPoolID sets the "sub_pool_id" field.
func (_u *APIKeyUpdateOne) SetSubPoolID(v int64) *APIKeyUpdateOne {
	_u.mutation.SetSubPoolID(v)
	return _u
}

// SetNillableSubPoolID sets the "sub_pool_id" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableSubPoolID(v *int64) *APIKeyUpdateOne {
	if v != nil {
		_u.SetSubPoolID(*v)
	}
	return _u
...
// ClearSubPoolID clears the value of the "sub_pool_id" field.
func (_u *APIKeyUpdateOne) ClearSubPoolID() *APIKeyUpdateOne {
	_u.mutation.ClearSubPoolID()
	return _u
}
...
// SetSubPool sets the "sub_pool" edge to the SubPool entity.
func (_u *APIKeyUpdateOne) SetSubPool(v *SubPool) *APIKeyUpdateOne {
	return _u.SetSubPoolID(v.ID)
}
...
// ClearSubPool clears the "sub_pool" edge to the SubPool entity.
func (_u *APIKeyUpdateOne) ClearSubPool() *APIKeyUpdateOne {
	_u.mutation.ClearSubPool()
	return _u
}
