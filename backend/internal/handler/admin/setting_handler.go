...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentRechargeBonusExpiryMode:                         paymentCfg.RechargeBonusExpiryMode,
		PaymentRechargeBonusEndsAt:                             paymentCfg.RechargeBonusEndsAt,
		PaymentRechargeBonusDurationDays:                       paymentCfg.RechargeBonusDurationDays,
		PaymentRechargeBonusStartedAt:                          paymentCfg.RechargeBonusStartedAt,
