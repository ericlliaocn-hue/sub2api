...
// (account_rate_version_id / account_rate_source / account_rate_snapshot); created_at
// is always last.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	...
	// created_at is last; session_id sits 5 args before it (before the three
	// account-rate version snapshot columns).
