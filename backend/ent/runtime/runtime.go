...
func init() {
	...
	apikeysubpoolbindingDescBoundAt := apikeysubpoolbindingFields[3].Descriptor()
	// apikeysubpoolbinding.DefaultBoundAt holds the default value on creation for the bound_at field.
	apikeysubpoolbinding.DefaultBoundAt = apikeysubpoolbindingDescBoundAt.Default.(func() time.Time)
	// apikeysubpoolbindingDescReason is the schema descriptor for reason field.
	apikeysubpoolbindingDescReason := apikeysubpoolbindingFields[5].Descriptor()
	// apikeysubpoolbinding.ReasonValidator is a validator for the "reason" field. It is called by the builders before save.
	apikeysubpoolbinding.ReasonValidator = apikeysubpoolbindingDescReason.Validators[0].(func(string) error)
	// apikeysubpoolbindingDescOperator is the schema descriptor for operator field.
	apikeysubpoolbindingDescOperator := apikeysubpoolbindingFields[6].Descriptor()
	// apikeysubpoolbinding.DefaultOperator holds the default value on creation for the operator field.
	apikeysubpoolbinding.DefaultOperator = apikeysubpoolbindingDescOperator.Default.(string)
	// apikeysubpoolbinding.OperatorValidator is a validator for the "operator" field. It is called by the builders before save.
	apikeysubpoolbinding.OperatorValidator = apikeysubpoolbindingDescOperator.Validators[0].(func(string) error)
	...
	// batchimagejobDescAccountRateSource is the schema descriptor for account_rate_source field.
	batchimagejobDescAccountRateSource := batchimagejobFields[23].Descriptor()
	// batchimagejob.AccountRateSourceValidator is a validator for the "account_rate_source" field. It is called by the builders before save.
	batchimagejob.AccountRateSourceValidator = batchimagejobDescAccountRateSource.Validators[0].(func(string) error)
	...
	// groupDescSubPoolEnabled is the schema descriptor for sub_pool_enabled field.
	groupDescSubPoolEnabled := groupFields[8].Descriptor()
	// group.DefaultSubPoolEnabled holds the default value on creation for the sub_pool_enabled field.
	group.DefaultSubPoolEnabled = groupDescSubPoolEnabled.Default.(bool)
	...
	subpoolMixin := schema.SubPool{}.Mixin()
	subpoolMixinHooks1 := subpoolMixin[1].Hooks()
	subpool.Hooks[0] = subpoolMixinHooks1[0]
	subpoolMixinInters1 := subpoolMixin[1].Interceptors()
	subpool.Interceptors[0] = subpoolMixinInters1[0]
	subpoolMixinFields0 := subpoolMixin[0].Fields()
	_ = subpoolMixinFields0
	subpoolFields := schema.SubPool{}.Fields()
	_ = subpoolFields
	// subpoolDescCreatedAt is the schema descriptor for created_at field.
	subpoolDescCreatedAt := subpoolMixinFields0[0].Descriptor()
	// subpool.DefaultCreatedAt holds the default value on creation for the created_at field.
	subpool.DefaultCreatedAt = subpoolDescCreatedAt.Default.(func() time.Time)
	// subpoolDescUpdatedAt is the schema descriptor for updated_at field.
	subpoolDescUpdatedAt := subpoolMixinFields0[1].Descriptor()
	// subpool.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	subpool.DefaultUpdatedAt = subpoolDescUpdatedAt.Default.(func() time.Time)
	// subpool.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	subpool.UpdateDefaultUpdatedAt = subpoolDescUpdatedAt.UpdateDefault.(func() time.Time)
	// subpoolDescName is the schema descriptor for name field.
	subpoolDescName := subpoolFields[1].Descriptor()
	// subpool.NameValidator is a validator for the "name" field. It is called by the builders before save.
	subpool.NameValidator = func() func(string) error {
		validators := subpoolDescName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// subpoolDescKind is the schema descriptor for kind field.
	subpoolDescKind := subpoolFields[3].Descriptor()
	// subpool.DefaultKind holds the default value on creation for the kind field.
	subpool.DefaultKind = subpoolDescKind.Default.(string)
	// subpool.KindValidator is a validator for the "kind" field. It is called by the builders before save.
	subpool.KindValidator = subpoolDescKind.Validators[0].(func(string) error)
	// subpoolDescStatus is the schema descriptor for status field.
	subpoolDescStatus := subpoolFields[4].Descriptor()
	// subpool.DefaultStatus holds the default value on creation for the status field.
	subpool.DefaultStatus = subpoolDescStatus.Default.(string)
	// subpool.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	subpool.StatusValidator = subpoolDescStatus.Validators[0].(func(string) error)
	// subpoolDescKeySoftLimit is the schema descriptor for key_soft_limit field.
	subpoolDescKeySoftLimit := subpoolFields[5].Descriptor()
	// subpool.DefaultKeySoftLimit holds the default value on creation for the key_soft_limit field.
	subpool.DefaultKeySoftLimit = subpoolDescKeySoftLimit.Default.(int)
	// subpoolDescSortOrder is the schema descriptor for sort_order field.
	subpoolDescSortOrder := subpoolFields[8].Descriptor()
	// subpool.DefaultSortOrder holds the default value on creation for the sort_order field.
	subpool.DefaultSortOrder = subpoolDescSortOrder.Default.(int)
	subpoolaccountFields := schema.SubPoolAccount{}.Fields()
	_ = subpoolaccountFields
	// subpoolaccountDescRole is the schema descriptor for role field.
	subpoolaccountDescRole := subpoolaccountFields[3].Descriptor()
	// subpoolaccount.DefaultRole holds the default value on creation for the role field.
	subpoolaccount.DefaultRole = subpoolaccountDescRole.Default.(string)
	// subpoolaccount.RoleValidator is a validator for the "role" field. It is called by the builders before save.
	subpoolaccount.RoleValidator = subpoolaccountDescRole.Validators[0].(func(string) error)
	// subpoolaccountDescCreatedAt is the schema descriptor for created_at field.
	subpoolaccountDescCreatedAt := subpoolaccountFields[4].Descriptor()
	// subpoolaccount.DefaultCreatedAt holds the default value on creation for the created_at field.
	subpoolaccount.DefaultCreatedAt = subpoolaccountDescCreatedAt.Default.(func() time.Time)
	...
	// usagelogDescAccountRateSource is the schema descriptor for account_rate_source field.
	usagelogDescAccountRateSource := usagelogFields[31].Descriptor()
	// usagelog.AccountRateSourceValidator is a validator for the "account_rate_source" field. It is called by the builders before save.
	usagelog.AccountRateSourceValidator = usagelogDescAccountRateSource.Validators[0].(func(string) error)
