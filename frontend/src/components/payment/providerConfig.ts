...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'huifu'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  huifu: '/api/v1/payment/webhook/huifu',
}
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  huifu: { notifyUrl: WEBHOOK_PATHS.huifu, returnUrl: RETURN_PATH },
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  huifu: [
    { key: 'sysId', label: '', sensitive: false },
