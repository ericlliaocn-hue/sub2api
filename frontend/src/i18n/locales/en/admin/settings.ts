export default {
    settings: {
      ...
      payment: {
        ...
        field_huifuPublicKey: 'Huifu RSA Public Key',
        field_projectTitle: 'Checkout Project Title',
        field_skillSource: 'API Source Identifier',
        field_huifuMerchantPrivateKeyHint: 'Signs requests sent to Huifu. It is encrypted at rest and never returned by the admin API.',
        field_huifuPublicKeyHint: 'Verifies Huifu synchronous responses and asynchronous notifications.',
        ...
        huifuGuideNote: 'Configure sys_id, huifu_id, product_id, project_id, the merchant private key, and the Huifu public key before enabling. The system generates the notification URL. Payment succeeds only after a verified notification or query result. Refunds stay disabled by default.',
        limitsTitle: 'Limits',
