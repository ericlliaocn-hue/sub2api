...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		AllowUserViewUsagePressure: func() bool {
			if req.AllowUserViewUsagePressure != nil {
				return *req.AllowUserViewUsagePressure
			}
			return previousSettings.AllowUserViewUsagePressure
		}(),
	...
	payload := dto.SystemSettings{
		...
		AllowUserViewUsagePressure:  updatedSettings.AllowUserViewUsagePressure,
	}
