export default {
  ...
  payment: {
    ...
    rechargeBonusTitle: 'Top-up Promotion',
    rechargeBonusHint: 'Pay an exact promotional amount to receive bonus $ Tokens. Bonuses are not included in the payment amount.',
    rechargeExchangeRate: 'Top-up rate: ¥1 = $1 Token',
    rechargeBonusCountdown: 'Limited-time promotion · ends in {time}',
    rechargeBonusPay: 'Pay {amount}',
    rechargeBonusGive: 'Get ${amount} Token',
    rechargeBonusValidity: 'Bonus expires in {days} days; limited to {times} claim(s) per user',
    rechargeBonusCredit: 'Total credit ${amount} Token',
    rechargeBonus: 'Promotion Bonus',
    balanceLedgerTitle: 'Balance History',
    activeBonusBalance: 'Active bonus balance ${amount}',
    ...
    admin: {
      ...
      rechargeBonusStats: 'Top-up Promotion Statistics',
      rechargeBonusOrders: 'Promotion Orders',
      rechargeBonusPayments: 'Promotion Payments',
      rechargeBonusGranted: 'Bonus $ Tokens',
      rechargeBonusCredited: 'Total Credited',
      rechargeBonusTier: 'Promotion Tier',
      rechargeBonusTierLabel: 'Pay {payment}, get ${bonus}',
      colUser: 'User',
      topUsers: 'Top Users',
      noData: 'No data',
      days: 'days',
