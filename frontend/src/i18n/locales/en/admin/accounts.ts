export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'When multiple users share the same OAuth account, converge device/session identifiers to account-level stable values to reduce upstream-visible device and session count. Device + session convergence is the default. If measurements show quota shrinkage, explicitly switch it off to pass client identifiers through unchanged.',
