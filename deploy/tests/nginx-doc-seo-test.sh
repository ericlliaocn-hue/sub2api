...
curl "${curl_args[@]}" --dump-header "${test_root}/analytics.headers" --output "${test_root}/analytics.js" "http://127.0.0.1:${site_port}/analytics.js"
...
grep -Fq 'id="LA_COLLECT" src="//sdk.51.la/js-sdk-pro.min.js"' "${test_root}/page.html"
grep -Fq 'src="/analytics.js"' "${test_root}/page.html"
grep -Eqi '^Content-Security-Policy: .*script-src[^;]*https://sdk\.51\.la' "${test_root}/page.headers"
...
grep -Eqi '^HTTP/[^ ]+ 200' "${test_root}/analytics.headers"
grep -Fq "3Qys0xvL3FiOExNW" "${test_root}/analytics.js"
