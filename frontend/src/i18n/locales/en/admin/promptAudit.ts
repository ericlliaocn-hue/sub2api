export default {
  promptAudit: {
    ...
    metrics: { total: 'Total', allowed: 'Allowed', flagged: 'Flagged', blocked: 'Blocked', busy: 'Busy', unavailable: 'Unavailable', timeouts: 'Timeouts', failovers: 'Failovers' },
    pool: {
    ...
    saveBar: { enabled: 'Enable prompt audit', blocking: 'Synchronous blocking', blockingLatestTurnOnly: 'Synchronously audit the latest client turn (full context reviewed in background)', storePass: 'Store safe events', dirty: 'Unsaved changes', synced: 'Configuration synced' },
    blockingConfirm: {
