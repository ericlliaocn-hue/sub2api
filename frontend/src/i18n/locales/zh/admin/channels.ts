export default {
    ...
    watchedTraffic: {
      title: '盯用户流量',
      hint: '只记指定用户的提示词和上游回包，不走内容审核、不打外部接口。关掉立刻走快路。观察池隔离不受影响。',
      switchLabel: '记录开关',
      on: '记录中',
      off: '已关闭',
      userIds: '用户 ID',
      userIdsHint: '逗号分隔。换 Key 也继续记。这个人喊慢就先关开关。',
      userIdsPlaceholder: '例如 295',
      saveUsers: '保存用户',
      recent: '最近记录',
      refresh: '刷新',
      loading: '加载中…',
      ...
      detail: '流量详情',
      enabled: '已打开流量记录',
      disabled: '已关闭流量记录，请求走快路',
      saved: '已保存',
      loadFailed: '加载流量记录配置失败',
      saveFailed: '保存流量记录配置失败',
      logsFailed: '加载流量记录失败',
    },
