...
const BADGE: Record<Platform, string> = {
  ...
  seedance: 'bg-amber-800/10 text-amber-800 border-amber-800/30 dark:bg-amber-500/10 dark:text-amber-200 dark:border-amber-500/30',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  seedance: 'bg-amber-800/10 text-amber-800 dark:bg-amber-500/10 dark:text-amber-200',
...
const BORDER: Record<Platform, string> = {
  ...
  seedance: 'border-amber-800/20 dark:border-amber-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  seedance: 'border-amber-800/35 dark:border-amber-500/35',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  seedance: 'bg-gradient-to-r from-amber-700 to-amber-900',
...
const TEXT: Record<Platform, string> = {
  ...
  seedance: 'text-amber-800 dark:text-amber-200',
...
const BUTTON: Record<Platform, string> = {
  ...
  seedance: 'bg-amber-800 text-white hover:bg-amber-900 active:bg-black dark:bg-amber-700 dark:hover:bg-amber-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  seedance: 'bg-amber-100 text-amber-800 dark:bg-amber-800 dark:text-amber-200',
...
const GRADIENT: Record<Platform, string> = {
  ...
  seedance: 'from-amber-700 to-amber-900',
