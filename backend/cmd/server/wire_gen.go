...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subPoolService := service.ProvideSubPoolService(subPoolRepository, groupRepository, apiKeyRepository, subPoolUsageRepository, subPoolMembership, apiKeyService)
	...
	subPoolHandler := admin.NewSubPoolHandler(subPoolService, subPoolGraduationService, settingService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, subPoolUserHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, handlerCreationHistoryHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
