...
type Account struct {
	...
	// 当前生效的上游倍率版本 ID
	ActiveUpstreamRateVersionID *int64 `json:"active_upstream_rate_version_id,omitempty"`
...
type AccountEdges struct {
	...
	// SubPools holds the value of the sub_pools edge.
...
// SubPoolsOrErr returns the SubPools value or an error if the edge
// was not loaded in eager-loading.
func (e AccountEdges) SubPoolsOrErr() ([]*SubPool, error) {
	if e.loadedTypes[1] {
		return e.SubPools, nil
	}
	return nil, &NotLoadedError{edge: "sub_pools"}
}
...
// was not loaded in eager-loading.
func (e AccountEdges) SubPoolAccountsOrErr() ([]*SubPoolAccount, error) {
	if e.loadedTypes[7] {
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldProxyID, account.FieldProxyFallbackOriginID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority, account.FieldActiveUpstreamRateVersionID, account.FieldParentAccountID:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldActiveUpstreamRateVersionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field active_upstream_rate_version_id", values[i])
			} else if value.Valid {
				_m.ActiveUpstreamRateVersionID = new(int64)
				*_m.ActiveUpstreamRateVersionID = value.Int64
			}
...
// QuerySubPools queries the "sub_pools" edge of the Account entity.
func (_m *Account) QuerySubPools() *SubPoolQuery {
	return NewAccountClient(_m.config).QuerySubPools(_m)
}
...
// QuerySubPoolAccounts queries the "sub_pool_accounts" edge of the Account entity.
func (_m *Account) QuerySubPoolAccounts() *SubPoolAccountQuery {
	return NewAccountClient(_m.config).QuerySubPoolAccounts(_m)
}
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	if v := _m.ActiveUpstreamRateVersionID; v != nil {
		builder.WriteString("active_upstream_rate_version_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
