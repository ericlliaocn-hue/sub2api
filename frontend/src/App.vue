...
import { PURCHASE_ROUTE_NAME, resolveRouteDocumentTitle } from '@/router/title'
...
function updateDocumentSEO() {
  ...
  // Official 0.2.5: /purchase title follows site billing mode. Keep anytoken public SEO.
