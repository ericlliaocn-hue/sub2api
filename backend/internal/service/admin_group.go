...
func defaultModelsListCandidateIDs(platform string) []string {
	...
	case PlatformSeedance:
		return []string{"seedance2", "seedance2.5", "seedance-mini", "seedance-fast", "seedance-key"}
...
func compositeDefaultModelsListCandidateIDs() []string {
	...
	ids := make([]string, 0)
	for _, platform := range []string{PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformAntigravity, PlatformGrok, PlatformSeedance, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax, PlatformOpenCodeGo} {
...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	group := &Group{
		...
		SubPoolEnabled:                  input.SubPoolEnabled,
		Status:                          StatusActive,
...
func (s *adminServiceImpl) UpdateGroup(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	if input.SubPoolEnabled != nil {
		group.SubPoolEnabled = *input.SubPoolEnabled
	}
	if input.Status != "" {
