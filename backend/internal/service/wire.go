...
// ProvideAdminService wires the optional manual-creation acquisition attribution
// (admin-created users land in the MANUAL system channel instead of OFFICIAL).
