export default {
  ...
  payment: {
    ...
    rechargeBonusTitle: '充值活动',
    rechargeBonusHint: '支付指定金额即可获得额外 $ Token，赠送额度不计入实付。',
    rechargeExchangeRate: '充值换算：¥1 = $1 Token',
    rechargeBonusCountdown: '限时活动 · 距结束 {time}',
    rechargeBonusPay: '支付 {amount}',
    rechargeBonusGive: '赠 ${amount} Token',
    rechargeBonusValidity: '赠送额度 {days} 天内有效，每位用户最多参与 {times} 次',
    rechargeBonusCredit: '合计到账 ${amount} Token',
    rechargeBonus: '活动赠送',
    balanceLedgerTitle: '余额流水',
    activeBonusBalance: '有效赠送余额 ${amount}',
    ...
    admin: {
      ...
      rechargeBonusStats: '充值活动统计',
      rechargeBonusOrders: '活动订单',
      rechargeBonusPayments: '活动支付额',
      rechargeBonusGranted: '赠送 $ Token',
      rechargeBonusCredited: '合计到账',
      rechargeBonusTier: '活动档位',
      rechargeBonusTierLabel: '支付 {payment} 赠 ${bonus}',
      colUser: '用户',
      topUsers: '消费排行',
      noData: '暂无数据',
      days: '天',
