export default {
    settings: {
      ...
      payment: {
        ...
        rechargeBonusTiers: 'Top-up Promotion Tiers',
        rechargeBonusTiersHint: 'A bonus applies only when the payment amount exactly matches a tier. Bonus tokens are excluded from payment, fees, and affiliate rebate calculations.',
        addRechargeBonusTier: 'Add Tier',
        bonusCurrency: 'Currency',
        bonusPaymentAmount: 'Payment Amount',
        bonusAmount: 'Bonus $ Tokens',
        bonusEnabled: 'Enabled',
        bonusExpiryMode: 'Promotion end mode',
        bonusExpiryByDays: 'Run for a number of days after activation',
        bonusExpiryFixed: 'Use a fixed end time',
        bonusDurationDays: 'Promotion duration (days)',
        bonusEndsAt: 'Promotion end time',
        bonusExpiryHint: 'The backend enforces expiry. Bonuses stop automatically, and ordinary saves do not restart a day-based countdown.',
        noRechargeBonusTiers: 'No promotion tiers configured',
        ...
        field_sysId: 'System ID (sys_id)',
        field_huifuId: 'Huifu Merchant ID (huifu_id)',
        field_productId: 'Product ID (product_id)',
        field_projectId: 'Checkout Project ID (project_id)',
        field_projectTitle: 'Checkout Project Title',
        field_skillSource: 'API Source Identifier',
        field_huifuApiBaseHint: 'Use https://api.huifu.com in production or https://spin-test.cloudpnr.com for integration testing.',
        field_huifuSkillSourceHint: 'Sent as the jpt-x-skill-source request header. Keep the default sub2api in normal deployments.',
        ...
        huifuGuideSummary: 'Huifu Dougong uses its hosted PC checkout on desktop and hosted H5 checkout on mobile.',
        huifuGuideNote: 'The page only stores sys_id, huifu_id, product_id, and project_id. The merchant private key and Huifu public key must come from read-only server secret files and never enter the page or database. The system generates the notification URL. Payment succeeds only after a verified notification or query result. Refunds stay disabled by default.',
        limitsTitle: 'Limits',
