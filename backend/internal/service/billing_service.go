...
func (s *BillingService) initFallbackPricing() {
	...
	// OpenAI GPT-6 Sol / Luna 官方价格（2026-09-23）；Fast 为标准价 2 倍，
	// >272K 输入时整单输入 2x、输出 1.5x。缓存写入为输入价的 1.25 倍。
...
// 的标准价倍率：gpt-5.6 / gpt-6 系（astra/sol/luna）/ gpt-5.4 为 2x，gpt-5.5 为 2.5x。
