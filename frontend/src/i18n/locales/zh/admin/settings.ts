export default {
    settings: {
      ...
      payment: {
        ...
        field_huifuPublicKey: '汇付 RSA 公钥',
        field_projectTitle: '收银台项目标题',
        field_skillSource: '接口来源标识',
        field_huifuMerchantPrivateKeyHint: '用于对发往汇付的请求签名，仅加密保存在服务端，不会由管理接口回传。',
        field_huifuPublicKeyHint: '用于校验汇付同步响应和异步通知签名，请填写汇付平台提供的公钥。',
        ...
        huifuGuideNote: '启用前必须配置 sys_id、huifu_id、product_id、project_id、商户私钥和汇付公钥。异步通知地址由系统生成，支付成功以验签后的异步通知或主动查询结果为准。退款默认关闭。',
        limitsTitle: '限额配置',
        limitSingleMin: '单笔最低',
        limitSingleMax: '单笔最高',
        limitDaily: '每日限额',
