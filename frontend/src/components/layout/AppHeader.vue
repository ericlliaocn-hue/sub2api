<template>
  <header class="app-header glass sticky top-3 z-30 mx-3 mt-3 rounded-2xl border border-gray-200/60 shadow-sm dark:border-dark-700/60 dark:shadow-black/10">
            ...
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              ...
              >
                <div class="flex items-start gap-2 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <div class="min-w-0">
                    <div>{{ t('common.contactSupport') }}:</div>
                    <div class="whitespace-pre-wrap break-words font-medium text-gray-700 dark:text-gray-300">{{
                      contactInfo
                    }}</div>
                  </div>
                </div>
